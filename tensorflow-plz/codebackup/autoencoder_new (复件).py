...
mnist = input_data.read_data_sets("/home/plz/tensorflow-mnist-predict/MNIST_data", one_hot=True)
...
# Network Parameters
n_hidden_1 = 8000 # 1st layer num features
n_hidden_2 = 200 # 2nd layer num features
n_input = 320000 # MNIST data input (img shape: 28*28)
